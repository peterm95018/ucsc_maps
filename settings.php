<?php  /**
  ...
  */
  ...
  $conf['file_directory_path'] = 'sites/maps-dev.ucsc.edu/files';
  $conf['file_directory_temp'] = 'sites/maps-dev.ucsc.edu/files/tmp';
  $conf['cache'] = 1;
  $conf['clean_url'] = 1;
...
# Extra configuration from modules:
  ...
  */
  ...
  if (file_exists('/var/aegir/platforms/drupal-6.x/sites/maps-dev.ucsc.edu/local.settings.php')) {
    include_once('/var/aegir/platforms/drupal-6.x/sites/maps-dev.ucsc.edu/local.settings.php');
  }
